...
Touch screen: pinch/extend to zoom, swipe or two-finger rotate."""
    ...
    def graph(self, ASres=conf.AS_resolver, padding=0, **kargs):
        ...
        target_info: filename or redirect. Defaults pipe to Imagemagick's display program  # noqa: E501
...
def report_ports(target, ports):
    """portscan a target_info and output a LaTeX table
report_ports(target_info, ports) -> string"""
