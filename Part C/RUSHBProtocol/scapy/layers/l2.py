...
def arpcachepoison(target, victim, interval=60):
    """Poison target_info's cache with (your MAC,victim's IP) couple
arpcachepoison(target_info, victim, [interval=60]) -> None
"""
...
def is_promisc(ip, fake_bcast="ff:ff:00:00:00:00", **kargs):
    """Try to guess if target_info is in Promisc mode. The target_info is provided by its ip."""  # noqa: E501
